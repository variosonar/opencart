...
$_['text_variant'] = 'Зверніть увагу, оскільки це варіативний товар, ви повинні змінити значення <a href="%s" target="_blank" class="alert-link">поточного товару</a>. В іншому випадку дані будуть замінені на дані <a href="%s" target="_blank" class="alert-link">головного товару</a> при збереженні.';
...
$_['entry_stock_status'] = 'Статус при відсутності';
$_['entry_price'] = 'Ціна';
...
$_['error_seo'] = 'SEO URL обов’язковий!';
